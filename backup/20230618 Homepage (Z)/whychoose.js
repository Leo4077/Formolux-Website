...
// ! Hover Drag
var ball = document.getElementById("drag-ball");
var cursorText = document.getElementById("cursor-text");

// > 這裡我們將 #homepage-carousel 加入到選擇器中
var hoverAreas = document.querySelectorAll('#homepage-carousel');
...
function handleMouseDown(e) {
    requestAnimationFrame(function () {
        ball.style.transform = 'scale(0.9) translate(-50%, -50%)';
        cursorText.style.transform = 'scale(0.9) translate(-50%, -50%)';
    });
}
